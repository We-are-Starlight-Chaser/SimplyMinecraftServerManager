...
namespace SimplyMinecraftServerManager.Internals.Downloads
{
    ...
    public class LeavesProvider(HttpClient? httpClient = null) : IServerProvider
    {
        ...
        /// <summary>
        /// 异步获取 Leaves 服务端所有可用的 Minecraft 版本列表。
        /// </summary>
        ...
        {
            string cacheKey = "leaves:versions";
        ...
        /// <summary>
        /// 异步获取指定 Minecraft 版本的所有 Leaves 服务端构建信息。
        /// </summary>
        ...
        /// <summary>
        /// 异步获取指定 Minecraft 版本的最新 Leaves 服务端构建。
        /// </summary>
